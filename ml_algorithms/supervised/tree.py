...
class DecisionTree:
    ...
    def _build_tree(self, x, y, depth=0):
        ...
        if (depth >= self.max_depth or n_values == 1 or n_samples < self.min_samples_split):
    ...
    def _best_criteria(self, x, y, feat_idxs):
        ...
        for feat_idx in feat_idxs:
            ...
            for threshold in thresholds:
                cost = self._cost_function(y, x_column, threshold)
...
class DecisionTreeRegressor(DecisionTree):
    ...
    def _variance_reduction(self, y, x_column, split_thresh):
        ...
        reduction = np.var(y) - (weight_l * np.var(y[left_idxs]) + weight_r * np.var(y[right_idxs]))
        return reduction
